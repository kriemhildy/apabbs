...
//! published. Bad actors are usually content to get their message heard even if it comes at the
//! cost of a ban. Reactive moderation causes unnecessary stress for moderators, as they have to be
...
pub const DEFAULT_PER_PAGE: usize = 240; // Evenly divisible by 1-6
